...
function onCreatePost()
  makeAnimatedLuaSprite('pink', 'mira/hearts', -25, 0)
  ...
  makeAnimatedLuaSprite('pinkglow', 'mira/hearts', -25, 0)
  ...
  makeLuaSprite('pink2', 'mira/vignette', -500,-500)
  addLuaSprite('pink2')
  scaleObject('pink2', 5, 5)
  setProperty('pink2.alpha', 0)
  setObjectCamera('pink2', 'hud')

  makeLuaSprite('pink22', 'mira/vignette2', 0,0)
  addLuaSprite('pink22')
