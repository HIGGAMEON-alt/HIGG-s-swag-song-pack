...
function onEvent(n,v1,v2)
	...
	if n == 'Add Alpha' and v1 == 'camHUD' then
	...
	if n == 'Alter Visibility' then
		if v1 == 'peter' and v2 == 'true' then
			setProperty('peter.y', 5183.3)
		end
	end
	
	if n == 'Alter Visibility' then
		if v1 == 'dee' and v2 == 'true' then
			setProperty('dee.y', 4901.75)
		end
	end

	if n == 'Alter Visibility' then
		if v1 == 'steven' and v2 == 'true' then
			setProperty('steven.y', 5077.65)
		end
	end
	...
	if n == 'Alter Visibility' and v1 == 'millerint' and v2 == 'false' then
		...
		introDone = true
		setProperty('camHUD.x',0)
		setProperty('boyfriend.y', getProperty('boyfriendGroup.y'))
	end
