...
function onCreatePost()
	objectPlayAnimation('dee', 'die', false)
	objectPlayAnimation('dee', 'singUP', false)
	objectPlayAnimation('dee', 'singDOWN', false)
	objectPlayAnimation('dee', 'singLEFT', false)
	objectPlayAnimation('dee', 'singRIGHT', false)
	objectPlayAnimation('dee', 'singUPmiss', false)
	objectPlayAnimation('dee', 'singDOWNmiss', false)
	objectPlayAnimation('dee', 'singLEFTmiss', false)
	objectPlayAnimation('dee', 'singRIGHTmiss', false)
	objectPlayAnimation('dee', 'idle', false)
	end
...
function onEvent(n,v1,v2)
	...
	if n == 'Object Play Animation' and v1 == 'dee' then
		...
		if string.sub(getProperty('dee.animation.curAnim.name'),1,4) == 'sing' then
			holdTimers.dee = 0
		end
	end
...
--function onUpdate()
--debugPrint(getPropertyFromClass('Conductor', 'songPosition') / 1000)
--end