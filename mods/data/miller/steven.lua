...
function onCreate()
	...
	setProperty('steven.y', 9999999999)
	...
	function onCreatePost()
		objectPlayAnimation('steven', 'die', false)
		objectPlayAnimation('steven', 'singUP', false)
		objectPlayAnimation('steven', 'singDOWN', false)
		objectPlayAnimation('steven', 'singLEFT', false)
		objectPlayAnimation('steven', 'singRIGHT', false)
		objectPlayAnimation('steven', 'singUPmiss', false)
		objectPlayAnimation('steven', 'singDOWNmiss', false)
		objectPlayAnimation('steven', 'singLEFTmiss', false)
		objectPlayAnimation('steven', 'singRIGHTmiss', false)
		objectPlayAnimation('steven', 'idle', false)
		end
