...
function onCreatePost()
	objectPlayAnimation('peter', 'die', false)
	objectPlayAnimation('peter', 'singUP', false)
	objectPlayAnimation('peter', 'singDOWN', false)
	objectPlayAnimation('peter', 'singLEFT', false)
	objectPlayAnimation('peter', 'singRIGHT', false)
	objectPlayAnimation('peter', 'singUPmiss', false)
	objectPlayAnimation('peter', 'singDOWNmiss', false)
	objectPlayAnimation('peter', 'singLEFTmiss', false)
	objectPlayAnimation('peter', 'singRIGHTmiss', false)
	objectPlayAnimation('peter', 'idle', false)
	end
