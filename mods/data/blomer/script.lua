...
function onSongStart()
    ...
    noteTweenX('bfTween1', 4, 90, 1.6, 'sineOut');
    noteTweenX('bfTween2', 5, 205, 1.6, 'sineOut');
    noteTweenX('bfTween3', 6, 315, 1.6, 'sineOut');
    noteTweenX('bfTween4', 7, 425, 1.6, 'sineOut');
    noteTweenX('dadTween1', 0, 730, 1.6, 'sineOut');
    noteTweenX('dadTween2', 1, 845, 1.6, 'sineOut');
    noteTweenX('dadTween3', 2, 955, 1.6, 'sineOut');
    noteTweenX('dadTween4', 3, 1065, 1.6, 'sineOut');
end
