...
function onUpdate(elapsed)
	...
	for i=0, getProperty('notes.length')-1 do
		...
		if tvSings == true and getPropertyFromGroup('notes', i, 'noteType') == '' and getPropertyFromGroup('notes', i, 'mustPress') then
			setPropertyFromGroup('notes', i, 'noteType', 'TV Sings')
			setPropertyFromGroup('notes', i, 'noAnimation', true)
		elseif tvSings == false and getPropertyFromGroup('notes', i, 'noteType') == 'TV Sings' and getPropertyFromGroup('notes', i, 'mustPress') then
			setPropertyFromGroup('notes', i, 'noteType', '')
			setPropertyFromGroup('notes', i, 'noAnimation', false)
		end
	end
