...
function onCreate()
    ...
    makeLuaSprite('BG1','BG/nightland/BG1',-1300,-1000)
    addLuaSprite('BG1',false)
    scaleObject('BG1',1.75, 1.75)
    setLuaSpriteScrollFactor('BG1', 0.2, 0.2);
    
    makeLuaSprite('BAC2','BG/nightland/BAC',-1700,-1200)
    addLuaSprite('BAC2',false)
    scaleObject('BAC2',1.75, 1.75)
    setLuaSpriteScrollFactor('BAC2', 0.6, 0.6);
    
    makeLuaSprite('GROUMD','BG/nightland/GROUMD',-2075,-1300)
    addLuaSprite('GROUMD',false)
    scaleObject('GROUMD',1.75, 1.75)
