...
function onCreate()
    ...
    makeLuaSprite('sky','BG/skatepark/sky',-350,-250)
    addLuaSprite('sky',false)
    setLuaSpriteScrollFactor('sky', 0.1, 0.1);
    
    makeLuaSprite('buildings','BG/skatepark/buildings',0,-50)
    addLuaSprite('buildings',false)
    setLuaSpriteScrollFactor('buildings', 0.8, 0.8);
    
    makeLuaSprite('s1','BG/skatepark/s1',0,0)
    addLuaSprite('s1',false)
    setLuaSpriteScrollFactor('s1', 1, 1);
