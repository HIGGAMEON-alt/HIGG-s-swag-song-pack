...
function onCreate()
	...
	if getDataFromSave("songSaveData", "showDisclaimer") then
		...
		makeLuaSprite("disclaimer", "menus/intro/pcport/disclaimer", wideScreen, 0)
...
function startIntro()
	if not initialized then
		...
		makeLuaSprite("titleText", "menus/intro/pcport/title-text", wideScreen, 0)
		...
		makeAnimatedLuaSprite("logo", "menus/intro/pcport/logo", wideScreen + 14 * 6, 7 * 6)
		...
		makeAnimatedLuaSprite("deluxe", "menus/intro/pcport/deluxe", wideScreen + 74 * 6, 44 * 6)
...
function onUpdate(elapsed)
	...
	if getTextString("curMenuGlobal") == "0" then
		...
		if keyJustPressed("accept") and not transitioning and initialized and canControl then
			...
			playSound("pcport/title_confirm", 0.45)
