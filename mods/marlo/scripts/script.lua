...
function onCreate()
    json = dofile('localrepotest%HIGG-s-swag-song-pack/mods/marlo/scripts/JSONLIB.lua')
...
function onCreatePost()
    ...
    if songName:lower() == "blomer" then
        makeChar('loitchsback', 'louitch', true, 'player', -200,-70)
        makeChar('blomie marlo', 'blomie marlo', true, 'player', getProperty('boyfriend.x')-500, getProperty('boyfriend.y') - 200)
